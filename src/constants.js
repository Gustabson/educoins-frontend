...
@keyframes coinFloat{0%{transform:translateY(0) scale(1.1) rotate(0deg);opacity:1}15%{opacity:1}70%{opacity:.7}100%{transform:translateY(-320px) scale(.2) rotate(60deg);opacity:0}}
@keyframes coinFloatL{0%{transform:translateY(0) scale(1.1) rotate(0deg);opacity:1}15%{opacity:1}70%{opacity:.7}100%{transform:translateY(-280px) translateX(-90px) scale(.2) rotate(-55deg);opacity:0}}
@keyframes coinFloatR{0%{transform:translateY(0) scale(1.1) rotate(0deg);opacity:1}15%{opacity:1}70%{opacity:.7}100%{transform:translateY(-300px) translateX(90px) scale(.2) rotate(45deg);opacity:0}}
`;
