...
@keyframes coinFloat{0%{transform:translateY(0) scale(1) rotate(0deg);opacity:1}20%{opacity:1}80%{opacity:.6}100%{transform:translateY(-160px) scale(.3) rotate(50deg);opacity:0}}
@keyframes coinFloatL{0%{transform:translateY(0) scale(1) rotate(0deg);opacity:1}20%{opacity:1}80%{opacity:.6}100%{transform:translateY(-130px) translateX(-50px) scale(.25) rotate(-40deg);opacity:0}}
@keyframes coinFloatR{0%{transform:translateY(0) scale(1) rotate(0deg);opacity:1}20%{opacity:1}80%{opacity:.6}100%{transform:translateY(-145px) translateX(50px) scale(.28) rotate(35deg);opacity:0}}
`;
