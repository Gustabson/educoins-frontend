...
function MDiwy({ me }) {
  ...
  // ── Detail: observaciones de un alumno ──
  if (selected) {
    return (
  ...
  return (
    <div style={{ minHeight:"100vh", background:pageBg, transition:"background .3s" }}>
      <OHdrA
        title="🐾 Diwy"
        extra={<div style={{ fontSize:12, opacity:.8, marginTop:2 }}>Seguimiento semanal de alumnos</div>}
      />
      <div style={{ padding:"16px 14px 32px" }}>
